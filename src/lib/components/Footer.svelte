...
<div class="relative">
  ...
  <div
    class="absolute left-1/2 lg:-right-[45%] transform -translate-x-1/2 -translate-y-[25%] w-full max-w-[546px] mx-auto"
  >
    <div
      class=" bg-gradient-light dark:bg-gradient-dark rounded-[32px] p-4 shadow-lg mx-5 border border-light-border dark:border-dark-border"
    >
      <h2
        class="text-[24px] lg:text-[36px] leading-[44px] lg:leading-[44px] font-semibold text-poppins text-black dark:text-white mb-2"
      >
        Stay Updated on Trends
      </h2>
      <p
        class="text-light-text-tertiary dark:text-dark-text-tertiary text-semi-body lg:text-body mb-6"
      >
      ...
      <form on:submit={handleSubmit} class="space-y-8">
        <div>
          <label
            for="email"
            class="block text-black dark:text-white text-semibody-medium mb-2"
            >Email address</label
          >
          <input
            type="email"
            ...
            class="w-full h-12 px-4 py-2 bg-white dark:bg-black border border-light-border dark:border-dark-border rounded-2xl focus:outline-none focus:border-brand-red placeholder:text-light-text-tertiary dark:placeholder:text-dark-text-tertiary text-light-text-primary dark:text-dark-text-primary text-mini-body"
            required
          />
        </div>
        <div>
          ...
          <p
            class="pt-4 px-[33px] text-light-text-tertiary dark:text-dark-text-tertiary text-semi-body text-center"
          >
            By contacting us you agree with our <a
              href="/terms"
              class="text-brand-red hover:underline">Terms of service</a
            >
            and
            <a href="/privacy" class="text-brand-red hover:underline"
              >Privacy Policy</a
            >
          </p>
        </div>
  ...
  <!-- Footer -->
  <footer
    class="pt-[378px] pb-[46px] px-4 lg:pt-[30px] lg:px-[60px] lg:pb-[96px] bg-gradient-light dark:bg-gradient-dark"
  >
    <div class=" mx-auto">
      <!-- Left Column -->
      <div class="flex flex-col gap-8">
        ...
        <nav class="flex gap-8 text-body font-medium">
          <a
            ...
            class="{$page.url.pathname === '/'
              ? 'text-brand-red'
              : 'text-light-text-primary dark:text-dark-text-primary'} hover:text-brand-red transition-colors"
          >
            Home
          </a>
          <a
        ...
        <div class="flex flex-col gap-5 lg:flex-row lg:gap-16 lg:items-center">
          <!-- Logo -->
          ...
          <div class="flex gap-6">
            ...
            >
              <svg class="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
                <g id="facebook.24.icon_1wRfb">
                  <path
                    id="Vector"
                    d="M17.0187 9.26613H13.8488V7.18613C13.8488 6.40613 14.3588 6.22613 14.7288 6.22613H16.9587V2.78613H13.8888C10.4688 2.78613 9.68875 5.34613 9.68875 6.98613V9.26613H7.71875V12.7861H9.68875V22.7861H13.8488V12.7861H16.6488L17.0088 9.26613H17.0187Z"
                    fill="currentColor"
                  />
                </g>
              </svg>
            ...
            >
              <svg class="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
                <g id="twitter.24.icon_34Z4B">
                  <path
                    id="Vector"
                    d="M14.4288 11.4061L21.1287 3.78613H19.5487L13.7188 10.4061L9.07875 3.78613H3.71875L10.7487 13.7861L3.71875 21.7861H5.30875L11.4487 14.7961L16.3588 21.7861H21.7188L14.4288 11.4061ZM12.2587 13.8861L11.5487 12.8861L5.87875 4.95613H8.31875L12.8888 11.3561L13.5988 12.3561L19.5487 20.6761H17.1087L12.2587 13.8761V13.8861Z"
                    fill="currentColor"
                  />
                </g>
              </svg>
            ...
            >
              <svg class="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
                <g id="linkedin.24.icon_baq3k">
                  <path
                    id="Vector"
                    d="M2.77953 9.38613H7.14953V22.5361H2.77953V9.37613V9.38613ZM4.98953 3.03613C3.48953 3.03613 2.51953 4.01613 2.51953 5.30613C2.51953 6.56613 3.46953 7.58613 4.93953 7.58613H4.95953C6.48953 7.58613 7.43953 6.56613 7.43953 5.30613C7.40953 4.01613 6.48953 3.03613 4.98953 3.03613ZM17.8895 9.06613C17.0962 9.03436 16.3094 9.2208 15.6147 9.60518C14.92 9.98956 14.344 10.5571 13.9495 11.2461V9.37613H9.56953C9.62953 10.6161 9.56953 22.5361 9.56953 22.5361H13.9495V15.1861C13.9495 14.7861 13.9695 14.4061 14.0895 14.1161C14.4095 13.3361 15.1295 12.5161 16.3295 12.5161C17.9195 12.5161 18.5495 13.7261 18.5495 15.4961V22.5361H22.9195V14.9961C22.9195 10.9461 20.7695 9.06613 17.8895 9.06613Z"
                    fill="currentColor"
                  />
                </g>
              </svg>
            ...
            >
              <svg class="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
                <g
                  id="youtube.24.icon_22zfT"
                  clip-path="url(#clip0_3729_56160)"
                >
                  <g id="Group">
                    <path
                      id="Vector"
                ...
                <defs>
                  <clipPath id="clip0_3729_56160">
                    <rect
                      ...
                      height="24"
                      fill="white"
                      transform="translate(0.71875 0.786133)"
                    />
                  </clipPath>
                </defs>
              </svg>
        ...
        <!-- Copyright -->
        <div
          class="h-[72px] lg:w-[40%] xl:w-[56%] text-light-text-tertiary dark:text-dark-text-tertiary text-mini-body leading-[16px]"
        >
          Copyright © {new Date().getFullYear()} Youversity. All rights reserved.<br
          />
          Youversity owns all content, technology, and intellectual property, protected
          under applicable copyright and trademark laws. Unauthorized use, reproduction,
          or distribution is strictly prohibited. We reserve the right to update,
          modify, or discontinue services as needed.
        </div>
      </div>
    </div>
  </footer>
