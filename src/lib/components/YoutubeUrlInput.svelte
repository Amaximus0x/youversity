...
>
  ...
  >
    ...
    <div class="space-y-8">
      <!-- Header -->
      <div class="flex justify-center items-center pb-4 border-b">
      ...
      <div class="space-y-4">
        ...
        <div class="space-y-2">
          <input
            ...
            class="w-full h-12 pl-4 pr-2 py-1.75 border rounded-2xl focus:ring-2 focus:ring-brand-red focus:border-transparent outline-none {error
              ? 'border-red-500'
              : ''}"
            disabled={loading}
          />
        ...
        <div class="flex justify-end">
          ...
          class="flex py-2 px-4 gap-2 rounded-full text-semibody-medium transition-colors {isPreviewEnabled
            ...
            : 'bg-Black/5 text-Grey'}"
        >
          Preview
          <svg class="w-6 h-6 transition-colors {isPreviewEnabled
            ? ' text-white'
            : ' text-Grey'}" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g id="play-circle-02">
