    ...
    >
      <div class="flex flex-col gap-8">
        <div class="flex flex-col gap-4">
          ...
          <!-- Course Description -->
          <p class="text-center text-semi-body text-light-text-secondary dark:text-dark-text-secondary">
        ...
        <!-- Enroll Button -->
        <button
          class="w-full px-4 py-3 flex items-center justify-center gap-2 bg-Green dark:bg-Green2 hover:bg-GreenHover text-white rounded-2xl transition-colors disabled:opacity-50"
