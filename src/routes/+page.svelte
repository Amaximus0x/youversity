...
<div class="min-h-screen flex flex-col">
  ...
  <!-- Hero Section -->
  <section
    class="flex-1 flex flex-col items-center justify-center px-4 pt-8 md:py-24 bg-light-bg-secondary dark:bg-dark-bg-secondary"
  >
    <div class="max-w-5xl mx-auto text-center flex flex-col items-center justify-center gap-14">
      ...
      <div class="flex flex-col md:flex-row gap-6 md:gap-16 justify-center">
        ...
        <button
          on:click={() => {}}
          class="px-10 py-4 border border-brand-red text-brand-red rounded-lg hover:bg-dark-bg-secondary transition-all text-body-semibold font-medium"
        >
          Watch Demo
        </button>
      </div>
  ...
  <section class="py-16 px-4 bg-light-bg-secondary dark:bg-dark-bg-secondary">
    <div class="max-w-6xl mx-auto">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        >
          <div
            class="w-12 h-12 bg-brand-turquoise/10 rounded-full flex items-center justify-center mb-4"
          >
            <svg
              width="24"
              height="24"
            ...
            >
              <path
                d="M18 18.7023C18.6224 18.3904 19.1716 17.9614 19.6177 17.4391M4 21.8208C4.91153 21.2736 6.14234 21 7.5 21C8.85766 21 10.0885 21.2736 11 21.8208M14 7C14 9.20914 12.2091 11 10 11C7.79086 11 6 9.20914 6 7C6 4.79086 7.79086 3 10 3C12.2091 3 14 4.79086 14 7ZM13.5 21C13.5 18.5147 11.4853 16.5 9 16.5C6.51472 16.5 4.5 18.5147 4.5 21M21.5 17.5C21.5 15.0147 19.4853 13 17 13C14.5147 13 12.5 15.0147 12.5 17.5"
                stroke="#42C1C8"
                stroke-width="1.5"
                stroke-linecap="round"
                stroke-linejoin="round"
          ...
          <p
            class="text-semi-body text-light-text-secondary dark:text-dark-text-secondary"
          >
            Connect with other learners, share insights, and collaborate on your
            educational journey.
          </p>
        </div>
        ...
        >
          <div
            class="w-12 h-12 bg-brand-navy/10 rounded-full flex items-center justify-center mb-4"
          >
            <svg
              width="24"
              height="24"
            ...
            >
              <path
                d="M12 6.5V15M12 15L16 11M12 15L8 11M20 18L4 18"
                stroke="#2A4D61"
                stroke-width="1.5"
                stroke-linecap="round"
                stroke-linejoin="round"
          ...
          <p
            class="text-semi-body text-light-text-secondary dark:text-dark-text-secondary"
          >
            Access your courses anytime, anywhere with our responsive platform
