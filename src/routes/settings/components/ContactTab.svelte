...
<div class="max-w-[632px] px-5 lg:px-0">
  <div class="flex flex-col gap-8">
    <!-- Header -->
    <div class="text-light-text-primary dark:text-dark-text-primary text-h2 md:text-h2">
      Contact Us
    </div>

    <!-- Contact Info -->
    <div class="w-full md:w-[310px] flex-col justify-start items-start gap-4 inline-flex">
    ...
    <div class="w-full bg-white dark:bg-dark-bg-primary rounded-[32px] border border-light-border dark:border-dark-border p-4  md:p-6 lg:p-8">
      ...
      <form on:submit|preventDefault={handleSubmit} class="flex flex-col gap-6">
        ...
        <div class="flex flex-col gap-4 mt-2">
          <button
            type="submit"
            class="w-full md:w-fit px-6 py-3 bg-brand-red hover:bg-ButtonHover rounded-2xl text-white text-body disabled:opacity-50 transition-colors"
            disabled={loading}
          >
